...
<div class="container">
    <header class="d-flex flex-wrap justify-content-center py-1 mb-2 border-bottom">
        <a href="/" class="d-flex align-items-center mb-1 mb-md-0 me-md-auto link-body-emphasis text-decoration-none">
            <img class="mb-1" src="image/logo_2.png" alt="Логотип" width="300" height="auto">
        </a>

        <ul class="nav nav-pills my-1">
            <li class="nav-item"><a href="control_dcsrb.php?week_set=now" class="nav-link <?=$active_now?>" aria-current="page">Текущая неделя</a></li>
            <li class="nav-item"><a href="control_dcsrb.php?week_set=last" class="nav-link <?=$active_last?>">Прошлая неделя</a></li>
            <li class="nav-item"><a href="control_dcsrb.php?week_set=next" class="nav-link <?=$active_next?>">Следующая неделя</a></li>
